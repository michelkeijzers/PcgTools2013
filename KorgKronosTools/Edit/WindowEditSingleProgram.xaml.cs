...
namespace PcgTools.Edit
{
    ...
    public partial class WindowEditSingleProgram // : Window
    {
        ...
        private void FillCategoryComboboxes(IGlobal global)
        {
            ...
            foreach (string categoryName in global.GetCategoryNames(Global.ECategoryType.Program))
            {
        ...
        private void ButtonOkClick(object sender, RoutedEventArgs e)
        {
            if (_ok)
            {
                ...
                {
                    IParameter param = _patch.GetParam(ParameterNames.ProgramParameterName.Category);
                    if (param != null)
                    {
